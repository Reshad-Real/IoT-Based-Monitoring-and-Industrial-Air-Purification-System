...
const float PM25_MULTIPLIER = 0.025;    // Multiply factor
const float PM10_OFFSET = 0.0;        // Add/subtract ug/m3
const float PM10_MULTIPLIER = 0.095;    // Multiply factor
...
// CO & NO2 Calibration
const float CO_SLOPE = 0.5;           // Voltage to ppm conversion
const float CO_OFFSET = 0.0;          // Add/subtract ppm
const float NO2_SLOPE = 90.0;        // Voltage to ppb conversion
